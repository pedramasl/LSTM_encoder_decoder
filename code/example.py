...
loss = model.train_model(X_train, Y_train, n_epochs = 100, target_len = ow, batch_size = 5, training_prediction = 'teacher_forcing', teacher_forcing_ratio = 0.6, learning_rate = 0.01, dynamic_tf = False)

# plot predictions on train/test data2
